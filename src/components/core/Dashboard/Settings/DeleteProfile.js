...
export default function DeleteProfile() {
  ...
  return (
    <div className={`my-10 flex flex-col sm:flex-row gap-x-5 rounded-md border-[1px] border-pink-700 bg-pink-900 p-8 px-4 sm:px-12 ${
        ...
        <div className={`flex flex-col space-y-2 ${
          isMediumScreenOrLarger ? "" : "items-center"
            ...
            onClick={handleDeleteAccount}>I want to delete my account.</button>
        </div>
    </div>
  )
}
